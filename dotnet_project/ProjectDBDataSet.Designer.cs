...
namespace dotnet_project {
    ...
    public partial class ProjectDBDataSet : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookRow AddBookRow(string Type, string Title, string Author, string Publisher, int Year, string ISBN, int Qty) {
...
namespace dotnet_project.ProjectDBDataSetTableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Book] ([Type], [Title], [Author], [Publisher], [Year], [ISBN]," +
                " [Qty]) VALUES (@Type, @Title, @Author, @Publisher, @Year, @ISBN, @Qty)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Book] SET [Type] = @Type, [Title] = @Title, [Author] = @Author, [Pu" +
                "blisher] = @Publisher, [Year] = @Year, [ISBN] = @ISBN, [Qty] = @Qty WHERE (([Id]" +
                " = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ProjectDBConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Type, Title, Author, Publisher, Year, ISBN, Qty FROM dbo.Book";
        ...
        public virtual int Fill(ProjectDBDataSet.BookDataTable dataTable) {
        ...
        public virtual ProjectDBDataSet.BookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProjectDBDataSet.BookDataTable dataTable = new ProjectDBDataSet.BookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProjectDBDataSet.BookDataTable dataTable) {
        ...
        public virtual int Insert(string Type, string Title, string Author, string Publisher, global::System.Nullable<int> Year, string ISBN, global::System.Nullable<int> Qty) {
            if ((Type == null)) {
        ...
        public virtual int Update(string Type, string Title, string Author, string Publisher, global::System.Nullable<int> Year, string ISBN, global::System.Nullable<int> Qty, int Original_Id) {
            if ((Type == null)) {
        ...
        public virtual int UpdateAll(ProjectDBDataSet dataSet) {
            ...
            try {
                ...
                if ((this._bookTableAdapter != null)) {
                    ...
                    this._bookTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(workConnection));
                    this._bookTableAdapter.Transaction = ((global::Microsoft.Data.SqlClient.SqlTransaction)(workTransaction));
                ...
                if ((this._bookTableAdapter != null)) {
                    this._bookTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(revertConnections[this._bookTableAdapter]));
